...
module.exports = (config) ->
  config.set
    ...
    files: [
      ...
      'dist/assets/lib/angular-1.3.15.min.js',
      'dist/assets/lib/angular-resource-1.3.15.min.js',
      'dist/assets/lib/angular-route-1.3.15.min.js',
      'dist/assets/lib/angular-animate-1.3.15.min.js',
